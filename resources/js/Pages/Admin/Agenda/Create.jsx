...
import 'flatpickr/dist/themes/airbnb.css'; // Optional cleaner theme
...
export default function Create({ salles }) {
    ...
    return (
        <AdminLayout user={auth.user}>
            <Head title="Ajouter un événement - LIXUS ADMIN" />
            ...
            <div className="mb-8 flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-slate-900">Ajouter un événement</h1>
                    <p className="text-slate-500 mt-1 text-sm">Créez un nouvel événement pour l'agenda.</p>
                </div>
            </div>
